...
1. Check if `.vcoding/PLAN.md` exists.
...
```
vcoding pick 42       # Fetch issue #42 → produce .vcoding/PLAN.md
vcoding do SPEC.md    # Use local spec  → produce .vcoding/PLAN.md
# Then implement according to .vcoding/PLAN.md
```

## Plan Structure

`.vcoding/PLAN.md` contains:
...
- `.vcoding/PLAN.md` is always the latest auto-generated plan — do not edit manually.
